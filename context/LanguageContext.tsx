...
const translations: { [lang in Language]: { [key: string]: string } } = {
  ...
  pt: {
    ...
    flagOfTheDay: "Bandeira em Destaque",
    ...
    noFavoritesDescription: "Marque as bandeiras com um coração para salvá-las em seus favoritos.",
    ...
    noFlagsForColor: "Nenhum design corresponde a esta tintura específica.",
