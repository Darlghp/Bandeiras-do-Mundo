...
const translations: { [lang in Language]: { [key: string]: string } } = {
  en: {
    ...
    toolsTab: "Utilities",
    quizStreak: "🔥 {{count}} Correct Streak",
  ...
  pt: {
    ...
    exploreSubtitle: "Descubra a história, o simbolismo e as cores vibrantes por trás das bandeiras das nações. Utilize nossos filtros para navegar pela rica tapeçaria da heráldica global.",
    searchPlaceholder: "Pesquise por nome ou sigla...",
    fetchError: "Não foi possível obter os dados. Tente novamente em instantes.",
    api_fetch_error: "Erro de conexão: Não foi possível carregar os dados das bandeiras.",
    errorOops: "Algo deu errado",
    noResults: "Nenhuma bandeira corresponde aos critérios atuais.",
    noFlagsFound: "Nenhuma Bandeira Encontrada",
    noFlagsFoundDescription: "Tente ajustar seus filtros ou termos de busca para descobrir novas nações.",
    ...
    quizTitle: "Quiz Vexilológico",
    questionOf: "Questão {{current}} de {{total}}",
    whichCountry: "A qual país pertence esta bandeira?",
    whichFlag: "Qual destas é a bandeira de {{country}}?",
    nextQuestion: "Continuar",
    quizResults: "Resumo de Desempenho",
    yourScore: "Precisão: {{score}} / {{total}}",
    playAgain: "Novo Jogo",
    backToExplorer: "Voltar à Galeria",
    scoreFeedbackExcellent: "Magistral! Seu conhecimento é de um verdadeiro especialista.",
    scoreFeedbackGood: "Trabalho impressionante! Você conhece muito bem o mapa-múndi.",
    scoreFeedbackAverage: "Bom esforço! Mais algumas rodadas e você será um expert.",
    scoreFeedbackPoor: "Um ótimo começo! Continue explorando para dominar a vexilologia.",
    discoverTitle: "Descobrir",
    discoverIntro: "Mergulhe no fascinante universo da vexilologia. Explore coleções curadas, designs únicos e o rico simbolismo global.",
    discoverLoading: "Preparando uma nova coleção para você...",
    ...
    selectDifficulty: "Nível de Dificuldade",
    difficultyEasy: "Iniciante",
    difficultyMedium: "Padrão",
    difficultyHard: "Especialista",
    difficultyEasyDesc: "Focado nas nações mais populosas e conhecidas mundialmente.",
    difficultyMediumDesc: "Uma mistura equilibrada de países de todos os cantos do globo.",
    difficultyHardDesc: "Desafie-se com territórios remotos e nações menos conhecidas.",
    ...
    modeCountryToCapitalDesc: "Relacione o estado soberano à sua respectiva capital.",
    ...
    whichCapital: "Qual é a capital deste país?",
    whichCoatOfArms: "De qual nação é este Brasão de Armas?",
    ...
    whichIsTheOddOneOut: "Qual destas bandeiras é a intrusa?",
    backToMenu: "Sair para o Menu",
    quizTime: "Tempo Decorrido",
    quizAvgTime: "Ritmo Médio",
    quizSeconds: "{{seconds}}s",
    compareMode: "Motor de Comparação",
    compareModeTooltip: "Ative para selecionar e comparar duas bandeiras lado a lado",
    exitCompareMode: "Sair da Comparação",
    selectForComparison: "Selecionar {{countryName}} para análise comparativa",
    compareFlags: "Comparar ({{count}}/2)",
    clearSelection: "Reiniciar",
    comparisonTitle: "Análise Comparativa de Bandeiras",
    favorites: "Minha Coleção",
    noFavorites: "Sua coleção está vazia",
    noFavoritesDescription: "Marque bandeiras com um coração para salvá-las na sua coleção pessoal.",
    ...
    continentTab: "Regiões",
    toolsTab: "Utilitários",
    quizStreak: "🔥 Sequência de {{count}} Acertos",
    quizHint: "Dica (restam {{count}})",
    quizNoHints: "Sem dicas disponíveis",
    quizReviewAnswers: "Analisar Desempenho",
    quizBackToSummary: "Voltar aos Resultados",
    quizReviewTitle: "Revisão Detalhada",
    quizYourAnswer: "Sua seleção:",
    quizCorrectAnswer: "Resposta correta:",
    continentHint: "Pista Regional: Localizado em {{continent}}.",
    quizBestStreak: "Maior Sequência",
    quizAccuracy: "Taxa de Acerto",
    quizRank: "Patente Alcançada",
    rankNovice: "Novato em Bandeiras",
    rankApprentice: "Aprendiz de Heráldica",
    ...
    sortPopAsc: "População (Crescente)",
    sortPopDesc: "População (Decrescente)",
    sortAreaAsc: "Área (Crescente)",
    sortAreaDesc: "Área (Decrescente)",
    selectACountry: "Selecione uma Nação",
    uniqueFlags: "Designs Notáveis",
    uniqueFlagOfTheDayTitle: "Destaque de Design do Dia",
    flagFactsTitle: "Curiosidades Vexilológicas",
    showAnotherFact: "Próxima Curiosidade",
    achievementsSubtitle: "Acompanhe seu progresso e marcos na exploração global.",
    symbolismExplorerTitle: "Motor de Simbolismo",
    symbolSun: "Sol Celestial",
    symbolCrescent: "Crescente Lunar",
    symbolCross: "Cruz Heráldica",
    ...
    noFlagsForSymbol: "Nenhum resultado para esta categoria de símbolo.",
    achievementUnlocked: "Marco Alcançado!",
    progress: "Progresso Atual",
    newBadge: "NOVO",
    level: "Nível",
    xp: "XP",
    nextLevelAt: "Próximo nível em {{xp}} XP",
    totalXP: "Experiência Total",
    vexMastery: "Domínio Vexilológico",
    ...
    cat_designer: "Visionário Criativo",
    ...
    achWorldTravelerDesc: "Descubra os detalhes de 50 bandeiras únicas.",
    achCenturyClubTitle: "Explorador do Século",
    ...
    achQuizScholarDesc: "Demonstre consistência completando 10 quizzes completos.",
    achQuizMarathonerTitle: "Maratonista do Saber",
    achQuizMarathonerDesc: "Um verdadeiro acadêmico! Complete 50 quizzes em qualquer modo.",
    achPerfectScoreTitle: "Execução Impecável",
    achPerfectScoreDesc: "Alcance 100% de precisão em qualquer desafio do quiz.",
    achPerfectLegendTitle: "Lenda Imaculada",
    achPerfectLegendDesc: "Alcance 10 pontuações perfeitas. A perfeição real é rara.",
    achStreakMasterTitle: "Momento Imparável",
    achStreakMasterDesc: "Mantenha uma sequência de 10 acertos consecutivos.",
    achStreakGodlikeTitle: "Deus da Vexilologia",
    achStreakGodlikeDesc: "Alcance uma sequência incrível de 25 acertos seguidos.",
    achCuratorTitle: "Curador do Registro",
    achCuratorDesc: "Construa uma coleção pessoal com 10 bandeiras favoritas.",
    achCollectorProTitle: "Colecionador Apaixonado",
    achCollectorProDesc: "Aumente sua coleção privada para 25 bandeiras.",
    achWorldCuratorTitle: "Grande Curador Global",
    achWorldCuratorDesc: "Colecione 50 bandeiras favoritas. O mundo está em suas mãos.",
    achArtistTitle: "Designer Heráldico",
    achArtistDesc: "Crie e exporte seu próprio design exclusivo de bandeira.",
    achProlificDesignerTitle: "Criador Prolífico",
    ...
    paraguayFlagDesc: "Única por apresentar emblemas diferentes no anverso e no reverso.",
    denmarkFlagDesc: "Reconhecida como a bandeira mais antiga do mundo em uso contínuo.",
    ...
    qatarFlagDesc: "A única bandeira nacional com largura superior ao dobro de sua altura.",
    belizeFlagDesc: "Distingue-se pela inclusão de figuras humanas em seu selo oficial.",
    cyprusFlagDesc: "Uma das poucas bandeiras a exibir o mapa literal da própria nação.",
    brazilFlagDesc: "Um retrato do céu sobre o Rio de Janeiro em 15 de novembro de 1889.",
    austriaFlagDesc: "Baseada em lendas medievais, entre os designs mais antigos da Europa.",
    lesothoFlagDesc: "Exibe o 'Mokorotlo', um chapéu tradicional do povo Basoto.",
    cambodiaFlagDesc: "A única bandeira nacional a apresentar um edifício (Angkor Wat).",
    turkmenistanFlagDesc: "Considerada a bandeira com o design mais complexo e detalhado do mundo.",
    sriLankaFlagDesc: "A 'Bandeira do Leão', simbolizando a bravura e as origens da nação.",
    canadaFlagDesc: "A icônica Folha de Bordo, símbolo de natureza e identidade canadense.",
    southAfricaFlagDesc: "O design da 'Nação Arco-Íris', adotado oficialmente em 1994.",
    dominicanRepublicFlagDesc: "A única bandeira nacional que apresenta uma Bíblia aberta.",
    jamaicaFlagDesc: "Um design exclusivo, livre das cores vermelho, branco e azul.",
    norwayFlagDesc: "Frequentemente chamada de 'Mãe de todas as bandeiras' por conter outros designs ocultos.",
    ugandaFlagDesc: "Apresenta centralmente o Grou-coroado, símbolo de elegância e mansidão.",
    bhutanFlagDesc: "Exibe o Dragão do Trovão (Druk) da mitologia local.",
    libyaFlagDesc: "Atualmente com o crescente, anteriormente um campo verde sólido.",
    saudiArabiaFlagDesc: "A única bandeira nunca hasteada a meio-mastro devido ao seu credo sagrado.",
    kiribatiFlagDesc: "Uma representação literal da localização geográfica do arquipélago.",
    dominicaFlagDesc: "Apresenta o Papagaio-imperial, ave endêmica da ilha.",
    eswatiniFlagDesc: "Exibe o escudo e as lanças do regimento Emasotsha.",
    southKoreaFlagDesc: "Centrada no 'Taegeuk', representando o equilíbrio cósmico.",
    lebanonFlagDesc: "Apresenta o Cedro, símbolo de santidade e eternidade.",
    kenyaFlagDesc: "O escudo Maasai simboliza a prontidão na defesa da liberdade nacional.",
    grenadaFlagDesc: "A 'Ilha das Especiarias', exibindo um dente de noz-moscada em seu design.",
    mexicoFlagDesc: "Inspirada na lenda asteca sobre a fundação de Tenochtitlán.",
    kyrgyzstanFlagDesc: "Os 40 raios do sol representam as 40 tribos originais do Quirguistão.",
    antiguaBarbudaFlagDesc: "Simboliza uma nova era (sol) e a herança africana (preto).",
    seychellesFlagDesc: "Faixas radiantes simbolizam um país dinâmico em constante movimento.",
    ...
    noFlagsForColor: "Nenhum resultado para esta categoria de símbolo.",
    ...
    star: "Estrela Astral",
    circle: "Círculo/Orbe",
    mainColor: "Campo Primário",
    crossColor: "Tintura da Cruz",
    colorN: "Tintura {{n}}",
    flagDesignerTitle: "Oficina de Heráldica",
    flagDesignerSubtitle: "Componha sua própria bandeira utilizando padrões e símbolos tradicionais da vexilologia.",
    layout: "Estrutura do Layout",
    colors: "Paleta de Cores",
    symbol: "Emblema Central",
    symbolColor: "Tintura do Emblema",
    actions: "Gerenciamento",
    randomize: "Gerar Aleatória",
    download: "Exportar SVG",
    guessTheFlag: "Bandeira Mistério",
    guessesLeft: "{{count}} tentativas restantes",
    congratulations: "Vitória!",
    gameOver: "Desafio Encerrado",
    correctAnswerWas: "A identidade correta era {{country}}",
    nextFlagIn: "Próximo desafio em",
    enterCountryName: "Digite o nome da nação...",
    all: "Registro Completo",
    allQuestions: "Todas as Questões Disponíveis",
    numberOfQuestions: "{{count}} Questões",
    selectNumberOfQuestions: "Definir Duração da Sessão",
    combo: "COMBO X{{n}}",
    timeLeft: "{{n}}s",
