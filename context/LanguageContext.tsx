...
const translations: { [lang in Language]: { [key: string]: string } } = {
  ...
  pt: {
    ...
    api_fetch_error: "Não foi possível carregar os dados das bandeiras. Verifique sua conexão.",
    ...
    achievementsSubtitle: "Acompanhe suas conquistas e marcos na exploração das bandeiras do mundo.",
    ...
    achQuizStarterTitle: "Início Acadêmico",
    achQuizStarterDesc: "Complete seu primeiro quiz.",
    achPerfectScoreTitle: "Precisão Perfeita",
    achPerfectScoreDesc: "Acerte 100% das questões em um quiz.",
    achStreakMasterTitle: "Imparável",
    ...
    flagFactsList: "[\"O **Nepal** é o único país do mundo com uma bandeira não quadrilátera.\", \"A bandeira da **Dinamarca** é a bandeira nacional mais antiga em uso contínuo, datando de 1219.\", \"A **Jamaica** é a única bandeira nacional atual que não contém as cores vermelho, branco ou azul.\", \"A **Suíça** e o **Vaticano** são os únicos dois estados soberanos com bandeiras nacionais quadradas.\", \"A bandeira de **Moçambique** é a única a apresentar um rifle de assalto moderno, simbolizando a defesa.\", \"**Belize** tem a única bandeira nacional que apresenta seres humanos como elemento principal.\", \"A bandeira das **Filipinas** é única porque é hasteada de cabeça para baixo (vermelho no topo) em tempos de guerra.\", \"A **Líbia** já teve a única bandeira nacional do mundo consistindo de uma única cor sólida: verde.\", \"O sol e a lua na bandeira do **Nepal** simbolizam a esperança de que a nação dure tanto quanto esses corpos celestes.\", \"As cores na bandeira da **Nação Arco-Íris** da África do Sul representam a unidade entre seu povo diversificado.\"]",
    mapTitle: "Mapa Mundi",
    mapSubtitle: "Explore o globo e descubra nações por sua localização.",
    mapComingSoon: "Explorador Geográfico",
    mapModeInstructions: "Utilize o mapa para navegar pelos países. Clique em uma tag de país para abrir sua bandeira e detalhes.",
    nepalFlagDesc: "A única bandeira nacional não quadrilátera do mundo.",
    switzerlandFlagDesc: "Uma das duas únicas bandeiras quadradas de estados soberanos.",
    vaticanFlagDesc: "A outra das duas únicas bandeiras quadradas de estados soberanos.",
    paraguayFlagDesc: "A única bandeira nacional com brasões diferentes no anverso e no reverso.",
    denmarkFlagDesc: "A bandeira nacional mais antiga em uso contínuo.",
    philippinesFlagDesc: "Hasteada de cabeça para baixo em tempos de guerra.",
    mozambiqueFlagDesc: "A única bandeira que apresenta um rifle de assalto moderno.",
    qatarFlagDesc: "A única bandeira nacional com largura mais de duas vezes sua altura.",
    belizeFlagDesc: "A única bandeira nacional que apresenta seres humanos como elemento principal.",
    ...
    lesothoFlagDesc: "Apresenta um mokorotlo, um chapéu de palha tradicional do Basoto.",
    cambodiaFlagDesc: "A única bandeira a apresentar um edifício (Angkor Wat).",
    turkmenistanFlagDesc: "Conhecida por ter o design de bandeira mais detalhado.",
    sriLankaFlagDesc: "Apresenta um leão dourado segurando uma espada kastane.",
    canadaFlagDesc: "A icônica folha de bordo foi adotada em 1965.",
    southAfricaFlagDesc: "A bandeira da 'Nação Arco-Íris' adotada após o apartheid.",
    dominicanRepublicFlagDesc: "A única bandeira que apresenta uma Bíblia.",
    jamaicaFlagDesc: "Uma das poucas bandeiras sem vermelho, branco ou azul.",
    norwayFlagDesc: "A 'Mãe de todas as bandeiras' contém várias outras bandeiras dentro dela.",
    ugandaFlagDesc: "Apresenta um Grou-coroado no centro.",
    bhutanFlagDesc: "Apresenta o Druk, o Dragão do Trovão da mitologia butanesa.",
    libyaFlagDesc: "Anteriormente a única bandeira verde sólida do mundo.",
    ...
    dominicaFlagDesc: "Apresenta um papagaio-imperial, endêmico da ilha.",
    eswatiniFlagDesc: "Apresenta um escudo e duas lanças do regimento Emasotsha.",
    southKoreaFlagDesc: "Apresenta o símbolo Taegeuk, representando o equilíbrio do universe (yin e yang).",
    lebanonFlagDesc: "Apresenta o Cedro-do-Líbano verde, um símbolo de santidade, eternidade e paz.",
    kenyaFlagDesc: "Apresenta um escudo tradicional Maasai e duas lanças, simbolizando a defesa da liberdade.",
    grenadaFlagDesc: "Conhecida como a Ilha das Especiarias, sua bandeira apresenta um dente de noz-moscada.",
    mexicoFlagDesc: "Retrata uma antiga lenda asteca de uma águia pousada em um cacto devorando uma serpente.",
    kyrgyzstanFlagDesc: "O sol amarelo possui 40 raios para as 40 tribos e um 'tunduk' (teto de iurta) no centro.",
    antiguaBarbudaFlagDesc: "O preto representa a herança africana, o sol uma nova era e o azul a esperança.",
    seychellesFlagDesc: "Apresenta cinco faixas radiantes representando um novo país dinâmico em direção ao futuro.",
    vanuatuFlagDesc: "Apresenta uma presa de javali (símbolo de prosperidade) e folhas de namele cruzadas (paz).",
    eritreaFlagDesc: "Apresenta uma coroa de ramos de oliveira, simbolizando a autonomia do país.",
    ...
    flagDesignerSubtitle: "Crie seu próprio design de bandeira único usando padrões e símbolos vexilológicos comuns.",
    layout: "Layout",
    colors: "Cores",
    symbol: "Símbolo",
