    ...
    return (
        <div 
            className={`
                ...
                opacity-0 animate-fade-in-up aspect-[3/4.2] border
        ...
        >
            ...
            <div className="absolute inset-0 z-0 bg-slate-200 dark:bg-slate-950 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent opacity-60 group-hover:opacity-75 transition-opacity duration-500"></div>
            </div>
            ...
            <div className="absolute top-4 left-4 right-4 z-20 flex justify-between items-start pointer-events-none">
                ...
                <div className="flex flex-col gap-2 items-end">
                    {isFavorite && !isSelectedForCompare && (
                        <div className="p-2 bg-red-500 rounded-xl shadow-lg border border-red-400 text-white">
                    ...
                    {isSelectedForCompare && (
                         <div className="p-2 bg-blue-600 text-white rounded-xl shadow-xl border border-blue-400 animate-bounce">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                <div className="bg-black/30 backdrop-blur-xl rounded-[1.8rem] p-4 border border-white/10 shadow-lg group-hover:bg-black/40 transition-colors">
                    <h3 className="text-lg font-black text-white tracking-tight leading-tight truncate group-hover:text-blue-200 transition-colors">
                        {commonName}
                    </h3>
                    
                    <div className="flex items-center gap-3 mt-2">
                        <span className="text-[10px] font-black text-blue-400 dark:text-sky-300 uppercase tracking-widest bg-blue-500/10 px-2 py-0.5 rounded-md">
                            {displayCca3}
                        </span>
