...
const translations: { [lang in Language]: { [key: string]: string } } = {
  en: {
    ...
    achAfricanSpecialistTitle: "Spirit of Africa",
    achAfricanSpecialistDesc: "Explore 20 different flags from the African continent.",
    achAsianSpecialistTitle: "Mysteries of Asia",
    achAsianSpecialistDesc: "Unlock the details of 20 unique Asian national flags.",
    achEuropeanSpecialistTitle: "European Heritage",
    achEuropeanSpecialistDesc: "Explore 20 flags from the historic nations of Europe.",
    achAmericanSpecialistTitle: "Pan-American Voyager",
    achAmericanSpecialistDesc: "Discover 20 flags across North and South America.",
    achOceanianSpecialistTitle: "Pacific Navigator",
    achOceanianSpecialistDesc: "Explore 10 unique flags from the islands of Oceania.",
    ...
    achQuizMarathonerDesc: "Complete 50 quizzes across any mode.",
    ...
    achQuizTitanDesc: "Achieve legendary status by completing 250 quizzes.",
    ...
    achStreakGodlikeTitle: "Streak God",
    achStreakGodlikeDesc: "Reach an incredible streak of 25 correct answers in a row.",
    achStreakUnrealTitle: "God of Knowledge",
    achStreakUnrealDesc: "Reach an unbelievable streak of 100 correct answers.",
    ...
    achJudgeMaestroTitle: "The Ultimate Judge",
    achJudgeMaestroDesc: "Perform 100 side-by-side flag comparisons.",
  ...
  pt: {
    ...
    difficultyHardDesc: "Dasafio-se com territórios remotos e nações menos conhecidas.",
    ...
    achVexScholarTitle: "Erudito Vexilológico",
    achVexScholarDesc: "Analise os detalhes de 200 designs nacionais únicos.",
    ...
    achAfricanSpecialistTitle: "Espírito da África",
    achAfricanSpecialistDesc: "Explore 20 bandeiras diferentes do continente africano.",
    achAsianSpecialistTitle: "Mistérios da Ásia",
    achAsianSpecialistDesc: "Desvende os detalhes de 20 bandeiras nacionais asiáticas.",
    achEuropeanSpecialistTitle: "Herança Europeia",
    achEuropeanSpecialistDesc: "Explore 20 bandeiras das nações históricas da Europa.",
    achAmericanSpecialistTitle: "Viajante Pan-Americano",
    achAmericanSpecialistDesc: "Descubra 20 bandeiras das Américas do Norte e do Sul.",
    achOceanianSpecialistTitle: "Navegador do Pacífico",
    achOceanianSpecialistDesc: "Explore 10 bandeiras das ilhas da Oceania.",
    ...
    achQuizMarathonerDesc: "Complete 50 quizzes em qualquer modo.",
    ...
    achQuizTitanDesc: "Alcance status lendário completando 250 quizzes.",
    ...
    achStreakGodlikeTitle: "Mestre da Sequência",
    achStreakGodlikeDesc: "Alcance uma sequência incrível de 25 acertos seguidos.",
    achStreakUnrealTitle: "Deus do Conhecimento",
    achStreakUnrealDesc: "Alcance uma sequência inacreditável de 100 acertos.",
    ...
    achAIExpertDesc: "Solicite 25 análises profundas da base de conhecimento do Vexy.",
    achAnalystTitle: "Analista Comparativo",
    achAnalystDesc: "Analise e compare 10 pares de bandeiras lado a lado.",
    achMasterAnalystTitle: "Grão-Mestre da Análise",
    achMasterAnalystDesc: "Realize 50 comparações detalhadas lado a lado.",
    achJudgeMaestroTitle: "O Juiz Supremo",
    achJudgeMaestroDesc: "Realize 100 comparações minuciosas de bandeiras.",
