                ...
                <div className="relative flex flex-col lg:flex-row items-center gap-12 p-8 sm:p-14">
                    ...
                    <div className="w-full lg:w-3/5 text-center lg:text-left space-y-6">
                        ...
                        <div className="pt-4">
                            <button 
                                onClick={() => onFlagClick(country)}
                                className="group relative inline-flex items-center gap-4 px-10 py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-2xl uppercase tracking-[0.2em] text-xs"
                            >
