...
const translations: { [lang in Language]: { [key: string]: string } } = {
  en: {
    ...
    modeDailyFlagle: "Daily Flagle",
    modeDailyFlagleDesc: "One flag, one chance. Everyone plays the same flag.",
    dailyChallenge: "Daily Challenge",
    unlimitedPractice: "Unlimited Practice",
    comeBackTomorrow: "Come back tomorrow for a new flag!",
    ...
    api_fetch_error: "Failed to load data. Please check your connection.",
  ...
  pt: {
    ...
    modeDailyFlagle: "Flagle Diário",
    modeDailyFlagleDesc: "Uma bandeira, uma chance. Todos jogam a mesma bandeira.",
    dailyChallenge: "Desafio Diário",
    unlimitedPractice: "Prática Infinita",
    comeBackTomorrow: "Volte amanhã para uma nova bandeira!",
    ...
    api_fetch_error: "Falha ao carregar dados. Verifique sua conexão.",
    ...
    rank: "Rank",
    perfectRun: "Corrida Perfeita",
    playAt: "Jogue em Flags Explorer"
  }
};
